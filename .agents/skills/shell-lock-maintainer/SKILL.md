---
name: shell-lock-maintainer
description: Maintain deprecated Shell Lock's commands, documentation, examples, and release material as a public reference implementation. Use for changes in this repository.
---
